...
<div class="container-fluid">
	...
	<div class="col-md-2">
		...
		<?php include 'category.php'; $categoryid = $_GET["catid"];?>
  ...
  <div class="col-md-10">
	...
	<div class="col-md-12">
			 <div class="grid-title">
			 	<?php 
		$sql = mysql_query("Select * from category  WHERE id = '".$categoryid."'");
			$kategoriBilgileri = mysql_fetch_assoc($sql)
			 	 ?>
			<i class="<?php echo $kategoriBilgileri["category_icon"] ?>"></i> <span><?php echo $kategoriBilgileri["category_name"] ?></span>
			</div>
		<?php 
			
			
			$sql = mysql_query("Select * from video  WHERE category_id = '".$categoryid."' ORDER BY RAND() LIMIT 24");
