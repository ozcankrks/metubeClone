...
<script src="https://raw.githubusercontent.com/msroot/Notify.js/master/Notify.js" ></script>
...
<div id="login-box">
  <div class="left">
    ...
    <input type="hidden"  name="password2" placeholder="Şifre Tekrar" />
    
    <input type="submit" name="signup_submit" value="Kayıt Ol" />
    </form>
...
<?php if ($_GET["stats"]== "no"){?>
  

<script type="text/javascript">
  $.notify("Bu Kullanıcı Adı veya E-mail Adresine tanımlı bir hesap bulunmakta!", "error");
</script>
<?php } ?>
